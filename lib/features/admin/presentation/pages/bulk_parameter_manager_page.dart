    ...
    for (final occ in selectedOccurrences) {
      try {
        ...
        final updatedTank = TankModel(
          ...
          inspectionProperties: propsList,
          scaleMin: tank.scaleMin,
          ...
          updatedAt: nowStr,
          inspectionFrequencyType: tank.inspectionFrequencyType,
          inspectionFrequencyDays: tank.inspectionFrequencyDays,
          groups: tank.groups,
        );

        await _tankRepo.updateTank(updatedTank);
